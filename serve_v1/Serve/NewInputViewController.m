...
//    
////    UIScrollView *scrollview = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, 390, self.view.frame.size.height)];
...
////    
////    [scrollview addSubview:self.addImageBackgroundView];
////    [scrollview addSubview:self.addPhotoActionSheetButton];
////    [scrollview addSubview:self.titleLabel];
////    [scrollview addSubview:self.titleInput];
////    [scrollview addSubview:self.descLabel];
////    [scrollview addSubview:self.descInput];
////    [scrollview addSubview:self.servesLabel];
////    [scrollview addSubview:self.servesInput];
////    [scrollview addSubview:self.addServeButton];
////    [scrollview addSubview:self.reduceServeButton];
////    [scrollview addSubview:self.typeLabel];
////    [scrollview addSubview:self.typeInput];
////    [scrollview addSubview:self.previousTypeButton];
////    [scrollview addSubview:self.nextTypeButton];
////    [scrollview addSubview:self.cuisineLabel];
////    [scrollview addSubview:self.cuisineInput];
