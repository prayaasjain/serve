...
- (void)viewDidLoad {
    ...
    [self.loginButton setTitleEdgeInsets:UIEdgeInsetsMake(0, 8, 0, 0)];
    
    
    //self.loginButton.translatesAutoresizingMaskIntoConstraints = NO;
    //[self.loginButton addTarget:self action:@selector(deleteButtonPressed:) forControlEvents:UIControlEventTouchUpInside];
