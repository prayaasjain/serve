...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.imageOne.image = [UIImage imageNamed:@"camera-2.png"];
        ...
        self.imageTwo.image = [UIImage imageNamed:@"camera-2.png"];
        ...
        self.imageThree.image = [UIImage imageNamed:@"camera-2.png"];
        ...
        self.imageFour.image = [UIImage imageNamed:@"camera-2.png"];
