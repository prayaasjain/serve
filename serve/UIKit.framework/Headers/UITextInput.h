...
/// This optional method is for clients that wish to put assistant buttons in the Unified Content Bar, shown on top of the keyboard.
/// You may modify the returned inputAssistantItem to add to or replace the existing items on the bar.
/// Modifications made to the returned UITextInputAssistantItem are reflected automatically.
- (UITextInputAssistantItem *)inputAssistantItem NS_AVAILABLE_IOS(9_0) __WATCHOS_PROHIBITED;
