...
UIKIT_EXTERN const UIFloatRange UIFloatRangeZero;
UIKIT_EXTERN const UIFloatRange UIFloatRangeInfinite;
UIKIT_EXTERN BOOL UIFloatRangeIsInfinite(UIFloatRange range);
UIKIT_EXTERN BOOL UIFloatRangeIsEqualToRange(UIFloatRange range, UIFloatRange otherRange);
...
@property (readwrite, nonatomic) CGFloat frictionTorque; // default is 0.0
@property (readwrite, nonatomic) UIFloatRange attachmentRange; // default is UIFloatRangeInfinite
